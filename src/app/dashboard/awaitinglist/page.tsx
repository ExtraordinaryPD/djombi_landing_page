...
const Dashboard: React.FC = () => {
  ...
  const [awaitingListModalOpen, setAwaitingListModalOpen] =
  ...
  useEffect(() => {
    ...
    event("ViewContent", {
      ...
      content_category: "User Dashboard/Awaiting list",
  ...
  const getActiveTabFeatures = (): Feature[] => {
      ...
      return [
        ...
        isActive:
          !!alwaysActiveFeatures[
            feature.id as keyof typeof alwaysActiveFeatures
          ],
      }));
    }
    ...
    return currentTabFeatures.map((feature) => ({
      ...feature,
      isActive:
        !!alwaysActiveFeatures[feature.id as keyof typeof alwaysActiveFeatures],
    }));
  };
